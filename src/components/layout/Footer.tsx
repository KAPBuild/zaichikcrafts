...
export default function Footer() {
  return (
    <footer className="bg-brand-black border-t border-wood-dark/30">
      {/* Wood grain top accent */}
      <div className="h-1 bg-gradient-to-r from-wood-dark via-wood-gold to-wood-dark" />
            ...
            <nav className="flex flex-col gap-2">
              {quickLinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className="text-off-white/60 hover:text-wood-gold transition-colors text-sm"
                >
                  {link.label}
                </Link>
              ))}
            ...
            <div className="space-y-3 text-sm text-off-white/60">
              ...
              <div className="flex gap-4 pt-3">
                <a
                  ...
                  className="text-off-white/40 hover:text-wood-gold transition-colors"
